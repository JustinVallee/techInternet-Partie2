...
var letters = {"Message3" : "Message3","Message4" : "Message4",};
var peers = {"http://localhost1226" : "http://localhost1226"};
...
app.get("http://localhost:1226/getPeers", (req, res)=>{
    res.json(Object.values(peers));
});

app.get("http://localhost:1226/getLetters", (req, res)=>{
    res.json(Object.values(letters));
});
